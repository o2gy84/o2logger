...
template<typename ...Args> void logi(const Args &...args)
{
    //logger::log_impl2('i', 0, std::forward<Args>(args)...);
    logger::log_impl2('i', 0, args...);
}
template<typename ...Args> void loge(const Args &...args)
{
    logger::log_impl2('e', 0, args...);
}
template<typename ...Args> void logw(const Args &...args)
{
    logger::log_impl2('w', 0, args...);
}
template<typename ...Args> void logd(const Args &...args)
{
    logger::log_impl2('d', 0, args...);
}
template<typename ...Args> void logd1(const Args &...args)
{
    logger::log_impl2('d', 1, args...);
}
template<typename ...Args> void logd2(const Args &...args)
{
    logger::log_impl2('d', 2, args...);
}
template<typename ...Args> void logd3(const Args &...args)
{
    logger::log_impl2('d', 3, args...);
}
template<typename ...Args> void logd4(const Args &...args)
{
    logger::log_impl2('d', 4, args...);
}
template<typename ...Args> void logd5(const Args &...args)
{
...
template<typename ...Args> void logi(const std::string &format, const Args &...args)
{
    logger::log_impl3('i', 0, format, args...);
}
template<typename ...Args> void loge(const std::string &format, const Args &...args)
{
    logger::log_impl3('e', 0, format, args...);
}
template<typename ...Args> void logw(const std::string &format, const Args &...args)
{
    logger::log_impl3('w', 0, format, args...);
}
template<typename ...Args> void logd(const std::string &format, const Args &...args)
{
    logger::log_impl3('d', 0, format, args...);
}
template<typename ...Args> void logd1(const std::string &format, const Args &...args)
{
    logger::log_impl3('d', 1, format, args...);
}
template<typename ...Args> void logd2(const std::string &format, const Args &...args)
{
    logger::log_impl3('d', 2, format, args...);
}
template<typename ...Args> void logd3(const std::string &format, const Args &...args)
{
    logger::log_impl3('d', 3, format, args...);
}
template<typename ...Args> void logd4(const std::string &format, const Args &...args)
{
    logger::log_impl3('d', 4, format, args...);
}
template<typename ...Args> void logd5(const std::string &format, const Args &...args)
{
